...
public class AutomatedTestScriptRestDaoTest extends RestDaoTest {
    ...
    public void getAll_shouldReturnClientScriptWithProperName() throws IOException {
        ...
        when(instance.getRestInterface().getRecords(any(SnowRestGetRequest.class))).thenReturn(
                Arrays.asList(readJsonObject("sys_variable_value-test.json"))
        );
        when(instance.getRestInterface().getRecord(SingleRecordSnowRestGetGetRequest.builder()
